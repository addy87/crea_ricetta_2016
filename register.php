...
<?php
	...
	if (isset($_GET["success"]) && empty($_GET["success"])) {
		...
		if (empty($_POST) === false) {
			$required_fields = array("username", "password", "password_again", "email", "risposta");
			...
			if (empty($errors) === true) {
				...
				if ($_POST["risposta"] !== 'roma' || $_POST["risposta"] !== 'roma') {
					$errors[] = "La risposta alla domanda di sicurezza è errata. Riprova.";
				}
...
?>
	...
	<form class="login-form animated bounceInLeft" action="" method="post">
		...
		<div class="form-group">
			<input type="text" class="form-control login-field" placeholder="Qual è la capitale d'Italia? (*)" name="risposta" />
			<label class="login-field-icon fui-question-circle" for="risposta"></label>
		</div>
