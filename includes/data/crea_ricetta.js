		...
		function print_pdf() {
			...
			var osservazioni = $("#osservazioni").val().replace(/\r\n|\r|\n/g,"<br />")

			osservazioni = osservazioni.replace(/<rosso>/g, '<span style="color:red">');
			osservazioni = osservazioni.replace(/<\/rosso>/g, '</span>');
			osservazioni = osservazioni.replace(/<verde>/g, '<span style="color:green">');
			osservazioni = osservazioni.replace(/<\/verde>/g, '</span>');
			osservazioni = osservazioni.replace(/<blu>/g, '<span style="color:blue">');
			osservazioni = osservazioni.replace(/<\/blu>/g, '</span>');
			

			console.log(osservazioni);

			elementi.push(osservazioni);
