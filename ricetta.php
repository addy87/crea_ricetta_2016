							...
							<div class="panel panel-default">
								...
								<div id="panel-osservazioni" class="panel-collapse collapse">
									<div class="panel-body" style="text-align:center">
										<button id="formattazione_bold" class="btn btn-formattazione btn-sm"><b>Grassetto</b></button>
										<button id="formattazione_italic" class="btn btn-formattazione btn-sm"><i>Italico</i></button>
										<button id="formattazione_underline" class="btn btn-formattazione btn-sm"><u>Sottolineato</u></button>
										<button id="formattazione_small" class="btn btn-formattazione btn-sm"><span style="font-size:10px">Piccolo</span></button>
										<button id="formattazione_link" class="btn btn-formattazione btn-sm"><u>Link</u></button>
										<button id="formattazione_rosso" class="btn btn-formattazione btn-sm"><rosso>Rosso</rosso></button>
										<button id="formattazione_verde" class="btn btn-formattazione btn-sm"><verde>Verde</verde></button>
										<button id="formattazione_blu" class="btn btn-formattazione btn-sm"><blu>Blu</blu></button>
