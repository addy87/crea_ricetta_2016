		...
		<div class="panel-body">
			<div class="col-md-12">
				...
				<form action="" method="get" id="form_inventario">
					...
					<a id="formattazione_bold" class="btn btn-formattazione btn-sm"><b>Grassetto</b></a>
					<a id="formattazione_italic" class="btn btn-formattazione btn-sm"><i>Italico</i></a>
					<a id="formattazione_underline" class="btn btn-formattazione btn-sm"><u>Sottolineato</u></a>
					<a id="formattazione_small" class="btn btn-formattazione btn-sm"><span style="font-size:10px">Piccolo</span></a>
					<a id="formattazione_link" class="btn btn-formattazione btn-sm"><u>Link</u></a>
					<a id="formattazione_rosso" class="btn btn-formattazione btn-sm"><rosso>Rosso</rosso></a>
					<a id="formattazione_verde" class="btn btn-formattazione btn-sm"><verde>Verde</verde></a>
					<a id="formattazione_blu" class="btn btn-formattazione btn-sm"><blu>Blu</blu></a>
						...
						foreach ($categorie as $categoria) {
							...
							foreach ($ingredienti_inventario as $ingrediente_inventario) {
								if($ingrediente_inventario["categoria"] == $categoria) {
									...
									echo'<div id="collapse'.$id.'" class="panel-collapse collapse"><div class="panel-body panel-body-ingrediente" style="text-align:center"><p class="small" style="font-size:11px">Se vuoi cambiare le informazioni su questo ingrediente, modifica i dati qui sotto e clicca il tasto AGGIORNA</p>';
...
<script type="text/javascript" src="includes/data/jquery.selection.js"></script>
<script>
	...
	function formattazioni() {
		$("#formattazione_bold").click( function() {
			console.log("dsa");
			formatta("<b>", "</b>");
		});
		$("#formattazione_italic").click( function() {
			formatta("<i>", "</i>");
		});
		$("#formattazione_underline").click( function() {
			formatta("<u>", "</u>");
		});
		$("#formattazione_small").click( function() {
			formatta("<small>", "</small>");
		});
		$("#formattazione_link").click( function() {
			formatta("<a href='INSERISCI QUI IL TUO LINK'>", "</a>");
		});
		$("#formattazione_rosso").click( function() {
			formatta("<rosso>", "</rosso>");
		});
		$("#formattazione_verde").click( function() {
			formatta("<verde>", "</verde>");
		});
		$("#formattazione_blu").click( function() {
			formatta("<blu>", "</blu>");
		});
	}

	function formatta(val1, val2) {
		$('textarea[name="inventario_note"]').selection('insert', {
				text: val1,
				mode: 'before'
			});
			$('textarea[name="inventario_note"]').selection('insert', {
...
<style>
	...
	#formattazione_rosso rosso, #formattazione_verde verde, #formattazione_blu blu{
		color: white;
	}
